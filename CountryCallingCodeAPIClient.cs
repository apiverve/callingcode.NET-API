...
namespace APIVerve
{
    public class CountryCallingCodeAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/callingcode";
        ...
        public CountryCallingCodeAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public CountryCallingCodeAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CountryCallingCodeQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(CountryCallingCodeQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(CountryCallingCodeQueryOptions options)
        {
